...
class ThemeUpdateChecker {
	public $theme = 'ndeso';              //The theme associated with this update checker instance.
	public $metadataUrl = 'http://new.wpndeso.com/ndeso.json';        //The URL of the theme's metadata file.
