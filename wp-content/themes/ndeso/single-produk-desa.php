		...
		<?php while (have_posts()): the_post(); ?>
			...
			<div <?php post_class('single clear'); ?> id="post_<?php the_ID(); ?>">
				...
				<div class="meta-info clear">
									    <strong>Nama Usaha / Pemilik</strong> <?php echo get_post_meta($post->ID, '_nama', true); ?><br/>
										<strong>Nomer Telepon</strong> <?php echo get_post_meta($post->ID, '_telp', true); ?><br/>
										<strong>Alamat</strong> <?php echo get_post_meta($post->ID, '_alamat', true); ?>
				</div>
